...
public class Pager {
	...
	public void init(int totalRecord, int currentPage) {
		...
		this.lastPage = this.firstPage + (this.blockSize-1);//firstPage와 (this.blockSize-1)만큼 간격 둠
		
		//thymeleaf break문이 없으므로 lastPage에 대한 조건 부여
		//lastpage보다 totalPage가 더 작다면 totalPage가 lastPage가 되면 됨
